...
namespace MyHW.DataSet1TableAdapters {
...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice" +
                ", UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM dbo.Products\r\nwher" +
                "e productname like \'%\'+@W+\'%\'";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@W", global::System.Data.SqlDbType.NVarChar, 40, global::System.Data.ParameterDirection.Input, 0, 0, "ProductName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
...
WHERE          (UnitPrice BETWEEN @unitprice1 AND @unitprice2)";
        ...
        public virtual int FillBysearchW(DataSet1.ProductsDataTable dataTable, string W) {
        ...
        public virtual DataSet1.ProductsDataTable GetDataBysearchW(string W) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((W == null)) {
                throw new global::System.ArgumentNullException("W");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int searchprice(DataSet1.ProductsDataTable dataTable, global::System.Nullable<decimal> unitprice1, global::System.Nullable<decimal> unitprice2) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DataSet1.ProductsDataTable GetDataBy(global::System.Nullable<decimal> unitprice1, global::System.Nullable<decimal> unitprice2) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((unitprice1.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(unitprice1.Value));
            }
